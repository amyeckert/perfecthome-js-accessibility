 ...
 *
  * Includes all of the following: TweenLite, TimelineLite, EasePack, CSSPlugin, ScrollToPlugin.min.js, TextPlugin.min.js, SplitTextPlugin.min.js
 *
...
!function(e){"use strict";var t=e.GreenSockGlobals||e,i=function(e){var i,n=e.split("."),s=t;for(i=0;n.length>i;i++)s[n[i]]=s=s[n[i]]||{};return s},n=i("com.greensock.utils"),s=function(e){var t=e.nodeType,i="";if(1===t||9===t||11===t){if("string"==typeof e.textContent)return e.textContent;for(e=e.firstChild;e;e=e.nextSibling)i+=s(e)}else if(3===t||4===t)return e.nodeValue;return i},l=document,r=l.defaultView?l.defaultView.getComputedStyle:function(){},o=/([A-Z])/g,h=function(e,t,i,n){var s;return(i=i||r(e,null))?(e=i.getPropertyValue(t.replace(o,"-$1").toLowerCase()),s=e||i.length?e:i[t]):e.currentStyle&&(i=e.currentStyle,s=i[t]),n?s:parseInt(s,10)||0},d=function(e){return e.length&&e[0]&&(e[0].nodeType&&e[0].style&&!e.nodeType||e[0].length&&e[0][0])?!0:!1},p=function(e){var t,i,n,s=[],l=e.length;for(t=0;l>t;t++)if(i=e[t],d(i))for(n=i.length,n=0;i.length>n;n++)s.push(i[n]);else s.push(i);return s},a=")eefec303079ad17405c",f=/(?:<br>|<br\/>|<br \/>)/gi,c=l.all&&!l.addEventListener,u="<div style='position:relative;display:inline-block;"+(c?"*display:inline;*zoom:1;'":"'"),g=function(e){e=e||"";var t=-1!==e.indexOf("++"),i=1;return t&&(e=e.split("++").join("")),function(){return u+(e?" class='"+e+(t?i++:"")+"'>":">")}},y=n.SplitText=t.SplitText=function(e,t){if("string"==typeof e&&(e=y.selector(e)),!e)throw"cannot split a null element.";this.elements=d(e)?p(e):[e],this.chars=[],this.words=[],this.lines=[],this._originals=[],this.vars=t||{},this.split(t)},x=function(e,t,i,n,o){f.test(e.innerHTML)&&(e.innerHTML=e.innerHTML.replace(f,a));var d,p,c,u,y,x,m,v,_,C,T,w,b,S=s(e),L=t.type||t.split||"chars,words,lines",H=-1!==L.indexOf("lines")?[]:null,N=-1!==L.indexOf("words"),W=-1!==L.indexOf("chars"),B="absolute"===t.position||t.absolute===!0,E=B?"&#173; ":" ",M=-999,k=r(e),R=h(e,"paddingLeft",k),A=h(e,"borderBottomWidth",k)+h(e,"borderTopWidth",k),O=h(e,"borderLeftWidth",k)+h(e,"borderRightWidth",k),$=h(e,"paddingTop",k)+h(e,"paddingBottom",k),j=h(e,"paddingLeft",k)+h(e,"paddingRight",k),G=h(e,"textAlign",k,!0),V=e.clientHeight,I=e.clientWidth,P=S.length,z="</div>",Q=g(t.wordsClass),Z=g(t.charsClass),q=-1!==(t.linesClass||"").indexOf("++"),D=t.linesClass;for(q&&(D=D.split("++").join("")),c=Q(),u=0;P>u;u++)x=S.charAt(u),")"===x&&S.substr(u,20)===a?(c+=z+"<BR/>",u!==P-1&&(c+=" "+Q()),u+=19):" "===x&&" "!==S.charAt(u-1)&&u!==P-1?(c+=z,u!==P-1&&(c+=E+Q())):c+=W&&" "!==x?Z()+x+"</div>":x;for(e.innerHTML=c+z,y=e.getElementsByTagName("*"),P=y.length,m=[],u=0;P>u;u++)m[u]=y[u];if(H||B)for(u=0;P>u;u++)v=m[u],p=v.parentNode===e,(p||B||W&&!N)&&(_=v.offsetTop,H&&p&&_!==M&&"BR"!==v.nodeName&&(d=[],H.push(d),M=_),B&&(v._x=v.offsetLeft,v._y=_,v._w=v.offsetWidth,v._h=v.offsetHeight),H&&(N!==p&&W||(d.push(v),v._x-=R),p&&u&&(m[u-1]._wordEnd=!0)));for(u=0;P>u;u++)v=m[u],p=v.parentNode===e,"BR"!==v.nodeName?(B&&(T=v.style,N||p||(v._x+=v.parentNode._x,v._y+=v.parentNode._y),T.left=v._x+"px",T.top=v._y+"px",T.position="absolute",T.display="block",T.width=v._w+1+"px",T.height=v._h+"px"),N?p?n.push(v):W&&i.push(v):p?(e.removeChild(v),m.splice(u--,1),P--):!p&&W&&(_=!H&&!B&&v.nextSibling,e.appendChild(v),_||e.appendChild(l.createTextNode(" ")),i.push(v))):H||B?(e.removeChild(v),m.splice(u--,1),P--):N||e.appendChild(v);if(H){for(B&&(C=l.createElement("div"),e.appendChild(C),w=C.offsetWidth+"px",_=C.offsetParent===e?0:e.offsetLeft,e.removeChild(C)),T=e.style.cssText,e.style.cssText="display:none;";e.firstChild;)e.removeChild(e.firstChild);for(b=!B||!N&&!W,u=0;H.length>u;u++){for(d=H[u],C=l.createElement("div"),C.style.cssText="display:block;text-align:"+G+";position:"+(B?"absolute;":"relative;"),D&&(C.className=D+(q?u+1:"")),o.push(C),P=d.length,y=0;P>y;y++)"BR"!==d[y].nodeName&&(v=d[y],C.appendChild(v),b&&(v._wordEnd||N)&&C.appendChild(l.createTextNode(" ")),B&&(0===y&&(C.style.top=v._y+"px",C.style.left=R+_+"px"),v.style.top="0px",_&&(v.style.left=v._x-_+"px")));N||W||(C.innerHTML=s(C).split(String.fromCharCode(160)).join(" ")),B&&(C.style.width=w,C.style.height=v._h+"px"),e.appendChild(C)}e.style.cssText=T}B&&(V>e.clientHeight&&(e.style.height=V-$+"px",V>e.clientHeight&&(e.style.height=V+A+"px")),I>e.clientWidth&&(e.style.width=I-j+"px",I>e.clientWidth&&(e.style.width=I+O+"px")))},m=y.prototype;m.split=function(e){this.isSplit&&this.revert(),this.vars=e||this.vars,this._originals.length=this.chars.length=this.words.length=this.lines.length=0;for(var t=0;this.elements.length>t;t++)this._originals[t]=this.elements[t].innerHTML,x(this.elements[t],this.vars,this.chars,this.words,this.lines);return this.isSplit=!0,this},m.revert=function(){if(!this._originals)throw"revert() call wasn't scoped properly.";for(var e=this._originals.length;--e>-1;)this.elements[e].innerHTML=this._originals[e];return this.chars=[],this.words=[],this.lines=[],this.isSplit=!1,this},y.selector=e.$||e.jQuery||function(t){return e.$?(y.selector=e.$,e.$(t)):l?l.getElementById("#"===t.charAt(0)?t.substr(1):t):t},y.version="0.2.4"}(_gsScope),function(e){"use strict";var t=function(){return(_gsScope.GreenSockGlobals||_gsScope)[e]};"function"==typeof define&&define.amd?define(["TweenLite"],t):"undefined"!=typeof module&&module.exports&&(module.exports=t())}("SplitText");